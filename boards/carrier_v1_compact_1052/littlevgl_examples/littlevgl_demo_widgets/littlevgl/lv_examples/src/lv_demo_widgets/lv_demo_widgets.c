 ...
 *  STATIC PROTOTYPES
 **********************/
static void simplia_create(lv_obj_t * parent);
...
void lv_demo_widgets(void)
{
    ...
    t0 = lv_tabview_add_tab(tv, "Simplia");
...
static void simplia_create(lv_obj_t * parent)
{
	...
	lv_img_set_src(icon, &simplia);
	lv_img_set_auto_size(icon, true);
	lv_obj_align_origo(icon, NULL, LV_ALIGN_CENTER, 0, 0);
...
static void controls_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_style_local_value_str(h, LV_CONT_PART_MAIN, LV_STATE_DEFAULT, "FreeRTOS Text input");
...
static void visuals_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_style_local_value_str(chart, LV_CONT_PART_MAIN, LV_STATE_DEFAULT, "FreeRTOS Line chart");
...
static void selectors_create(lv_obj_t * parent)
{
    ...
    lv_table_set_cell_value(table1, 7, 0, "6");
    lv_table_set_cell_value(table1, 8, 0, "6");
    lv_table_set_cell_value(table1, 9, 0, "6");
    lv_table_set_cell_value(table1, 10, 0, "6");
    lv_table_set_cell_value(table1, 11, 0, "6");
    lv_table_set_cell_value(table1, 12, 0, "6");
    lv_table_set_cell_value(table1, 13, 0, "6");
    lv_table_set_cell_value(table1, 14, 0, "6");
    lv_table_set_cell_value(table1, 15, 0, "6");
    lv_table_set_cell_value(table1, 16, 0, "6");
    lv_table_set_cell_value(table1, 17, 0, "6");
    ...
    lv_table_set_cell_value(table1, 7, 1, "George");
    lv_table_set_cell_value(table1, 8, 1, "George");
    lv_table_set_cell_value(table1, 9, 1, "George");
    lv_table_set_cell_value(table1, 10, 1, "George");
    lv_table_set_cell_value(table1, 11, 1, "George");
    lv_table_set_cell_value(table1, 12, 1, "George");
    lv_table_set_cell_value(table1, 13, 1, "George");
    lv_table_set_cell_value(table1, 14, 1, "George");
    lv_table_set_cell_value(table1, 15, 1, "George");
    lv_table_set_cell_value(table1, 16, 1, "George");
    lv_table_set_cell_value(table1, 17, 1, "George");
    ...
    if(disp_size > LV_DISP_SIZE_SMALL) {
        ...
        lv_table_set_cell_value(table1, 7, 2, "Athen");
        lv_table_set_cell_value(table1, 8, 2, "Athen");
        lv_table_set_cell_value(table1, 9, 2, "Athen");
        lv_table_set_cell_value(table1, 10, 2, "Athen");
        lv_table_set_cell_value(table1, 11, 2, "Athen");
        lv_table_set_cell_value(table1, 12, 2, "Athen");
        lv_table_set_cell_value(table1, 13, 2, "Athen");
        lv_table_set_cell_value(table1, 14, 2, "Athen");
        lv_table_set_cell_value(table1, 15, 2, "Athen");
        lv_table_set_cell_value(table1, 16, 2, "Athen");
        lv_table_set_cell_value(table1, 17, 2, "Athen");
