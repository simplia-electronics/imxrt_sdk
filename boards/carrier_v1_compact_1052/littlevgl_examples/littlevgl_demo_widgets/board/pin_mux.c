...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
		  IOMUXC_GPIO_AD_B0_09_GPIO1_IO09,        /* GPIO_AD_B0_02 is configured as GPIO1_IO02 */
        0U);
...
#if 0
  IOMUXC_SetPinMux(
        IOMUXC_GPIO_B1_14_GPIO2_IO30,           /* GPIO_B1_15 is configured as GPIO2_IO31 */
        0U);
#endif
  IOMUXC_SetPinConfig(
		  IOMUXC_GPIO_AD_B0_09_GPIO1_IO09,        /* GPIO_AD_B0_02 PAD functional properties : */
        0x10B0u);
...
#if 0
  IOMUXC_SetPinConfig(
        IOMUXC_GPIO_B1_14_GPIO2_IO30,           /* GPIO_B1_15 PAD functional properties : */
        0x10B0u);
#endif
  IOMUXC_SetPinConfig(
...
void BOARD_InitI2C1Pins(void) {
  ...
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_SD_B1_04_LPI2C1_SCL,        /* GPIO_AD_B1_00 is configured as LPI2C1_SCL */
      1U);                                    /* Software Input On Field: Force input path of pad GPIO_AD_B1_00 */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_SD_B1_05_LPI2C1_SDA,        /* GPIO_AD_B1_01 is configured as LPI2C1_SDA */
      1U);                                    /* Software Input On Field: Force input path of pad GPIO_AD_B1_01 */
  IOMUXC_SetPinConfig(
		  IOMUXC_GPIO_SD_B1_04_LPI2C1_SCL,        /* GPIO_AD_B1_00 PAD functional properties : */
      0xD8B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                 ...
                                                 Hyst. Enable Field: Hysteresis Disabled */
  IOMUXC_SetPinConfig(
		  IOMUXC_GPIO_SD_B1_05_LPI2C1_SDA,        /* GPIO_AD_B1_01 PAD functional properties : */
      0xD8B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Enabled
