...
/* Back light. */
#define LCD_BL_GPIO     					COMPACT_1052_DISP_GPIO
#define LCD_BL_GPIO_PIN 					COMPACT_1052_DISP_PIN
...
#endif
static ft5426_handle_t touchHandle;
...
static void DEMO_InitTouch(void)
{
    ...
    status = FT5426_Init(&touchHandle, TOUCH_I2C);
...
static bool DEMO_ReadTouch(lv_indev_drv_t *drv, lv_indev_data_t *data)
{
    ...
    if (kStatus_Success == FT5426_GetSingleTouch(&touchHandle, &touch_event, &touch_x, &touch_y))
    {
