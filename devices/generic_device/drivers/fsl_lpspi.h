...
typedef enum _lpspi_which_pcs_config
{
	...
	kLPSPI_Pcs_ClickBoard0 = 4U, /* PCS Click Board 0 */
	kLPSPI_Pcs_ClickBoard1 = 5U, /* PCS Click Board 1 */
} lpspi_which_pcs_t;
...
enum _lpspi_transfer_config_flag_for_master
{
	...
	kLPSPI_Master_PcsClickBoard0 = 4U << LPSPI_MASTER_PCS_SHIFT,
	kLPSPI_Master_PcsClickBoard1 = 5U << LPSPI_MASTER_PCS_SHIFT,
